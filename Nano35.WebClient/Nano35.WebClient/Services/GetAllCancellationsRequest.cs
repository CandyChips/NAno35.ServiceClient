...
namespace Nano35.WebClient.Services
{
        ...
        RequestProvider<GetAllCancellationsHttpQuery, GetAllCancellationsSuccessHttpResponse>
    {
        ...
        {
            var response = await HttpClient.GetAsync($"{RequestManager.LocalStorageServer}/Warehouse/GetAllCancellations?InstanceId={Request.InstanceId}&UnitId={Request.UnitId}");
